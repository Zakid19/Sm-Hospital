    ...
    <div class="container d-flex align-items-center">
      ...
      @if (Auth::user()->role_id == '3')
        ...
        @if (empty(Auth::user()->appointment))
            ...
            @else
                <a href="{{ route('my-appointment') }}" class="appointment-btn scrollto"><span class="d-none d-md-inline">My Appointment</span></a>
            @endif
        @endif

        <a class="appointment-btn scrolltoappointment-btn scrollto" href="{{ route('logout') }}"
