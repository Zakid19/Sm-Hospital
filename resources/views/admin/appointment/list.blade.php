                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            <a type="button" href="{{ route('admin.appointment.cek', $appointment) }}" class="btn btn-link btn-success btn-lg"
                                            data-toggle="tooltip" title="" data-original-title="Cek Data">
                                                <i class="fas fa-money-check"></i>
                                            </a>

                                            <form action="{{ route('admin.appointment.delete', $appointment) }}" method="post">
                                                @csrf
                                                @method('delete')
